...
import "./chunk-HCMSWYUE.js";
import "./chunk-RSJERJUL.js";

// node_modules/.pnpm/typesafe-i18n@5.15.0_typescript@4.8.4/node_modules/typesafe-i18n/svelte/index.mjs
  ...
  (value, formatterKey) => {
    ...
    return (_b = formatterKey.match(REGEX_SWITCH_CASE) ? (() => {
      ...
      const cases = Object.fromEntries(
        removeOuterBrackets(formatterKey).split(",").map((part) => part.split(":").map((value2) => value2.trim()))
      );
